...
namespace InRiver.Rest.Lib.Model
{
    ...
    public class UrlFileModelWithLink :  IEquatable<UrlFileModelWithLink>
    {
        ...
        public UrlFileModelWithLink(string url = default(string), string overrideUrlFileName = default(string), ResourceLinkModel resourceLink = default(ResourceLinkModel))
        {
            this.Url = url;
        ...
        {
            return this.Equals(input as UrlFileModelWithLink);
        }
